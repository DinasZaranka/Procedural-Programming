    ...
    while(1){
        ...
        if(scanf("%d%c",&n,&ch) == 2){
            if(ch == '\n'){
                ...
                printf("Jus ivedete netinkama skaiciu, iveskite kita skaiciu!\n");
                scanf("%*[^\n]");
            }
        } else {
            printf("Jusu ivestis neteisinga, iveskite kita skaiciu!\n");
            scanf("%*[^\n]");
        }
    }
}
...
int main(){
    ...
    int n = getInt();
    while(n < 1){
    printf("Jusu skaicius negali buti maziau 1, iveskite kita skaiciu!\n");
    n = getInt();
    }
