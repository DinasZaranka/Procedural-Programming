# 4 uzd 8 variantas ciklinio dvipusio sąrašo programa, su funkcija kuri ismeta is saraso didziausia elementa.
...
2. Vardo taisykles
    ...
    void print_recursive(Node *start, Node *current);
    ```
    # Blogas pavyzdys
    ```c
    void Insert();
